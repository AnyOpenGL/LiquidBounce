...
import net.ccbluex.liquidbounce.deeplearn.data.TrainingDataMinarai.Companion.AGE
import net.ccbluex.liquidbounce.deeplearn.data.TrainingDataMinarai.Companion.CURRENT_DIRECTION_VECTOR
import net.ccbluex.liquidbounce.deeplearn.data.TrainingDataMinarai.Companion.DELTA_VECTOR
import net.ccbluex.liquidbounce.deeplearn.data.TrainingDataMinarai.Companion.DISTANCE
import net.ccbluex.liquidbounce.deeplearn.data.TrainingDataMinarai.Companion.HURT_TIME
import net.ccbluex.liquidbounce.deeplearn.data.TrainingDataMinarai.Companion.PREVIOUS_DIRECTION_VECTOR
import net.ccbluex.liquidbounce.deeplearn.data.TrainingDataMinarai.Companion.P_DIFF
import net.ccbluex.liquidbounce.deeplearn.data.TrainingDataMinarai.Companion.TARGET_DIRECTION_VECTOR
import net.ccbluex.liquidbounce.deeplearn.data.TrainingDataMinarai.Companion.T_DIFF
import net.ccbluex.liquidbounce.utils.aiming.data.Rotation
import net.minecraft.util.math.Vec2f
import net.minecraft.util.math.Vec3d
import java.io.File

data class TrainingDataJumpReset(
