 ...
 */
package net.ccbluex.liquidbounce.deeplearn.models.velocitymodel
...
abstract class VelocityModelWrapper<I, O>(
    name: String,
...
private fun createMlpBlock(outputs: Long) =
    SequentialBlock().apply {
        ...
        add(
            LSTM
                .Builder()
                .setStateSize(128) // LSTM隐藏层大小
                .setNumLayers(1) // LSTM层数
                .optReturnState(true) // 是否返回状态
                .build(),
        )
        // 添加全连接层
